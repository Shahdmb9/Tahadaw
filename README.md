...
> **نبذة بالعربية**
> **تهادّو** هو نظام  (Backend) مبني على Spring Boot يساعد المستخدم على تخطيط الهدية المثالية.
> انشئ ملفًا تعريفيًا عن المُهدى إليه، التطبيق سيطرح أسئلة إلزامية وأسئلة ذكية مولّدة بالذكاء الاصطناعي،
> ثم يقترح أفكار هدايا للمُهدى إليه بناءًا على ملفه و اجاباتك على الاساله المولده من الذكاء الاسطناعي ويبحث عن منتجات حقيقية ،
...
**[Tahadaw UI — Figma (تهادوا)](https://www.figma.com/design/1kn0xnKDmQyf60eT7sz27N/%D8%AA%D9%87%D8%A7%D8%AF%D9%88%D8%A7?node-id=274-758&t=0gAjgk2GyDalTl9u-1)**
